...
Therefore this plugin can be used to fully anonymize your user including the ip-address. Call `/anonymize-plugin/users/<userId>/anonymize` (PUT) to reach this endpoint.
